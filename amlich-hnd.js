...
console.log("JDN =>", jdn(20, 2, 2021));
console.log("J2D =>", jdn2date(jdn(20, 2, 2021)));
...
var currentLunarDate = getLunarDate(
  today.getDate(),
  today.getMonth() + 1,
  today.getFullYear()
);
...
function getDayName(lunarDate) {
  ...
  var s = "Ngay " + cc[0] + ", thang " + cc[1] + ", n\u0103m " + cc[2];
  return s;
}
...
function getTodayString() {
  ...
  s += " n\u0103y nganm " + getYearCanChi(currentLunarDate.year);
  return s;
}
...
function printYear(yy) {
  ...
  res +=
    '<tr><td colspan="3" class="tennam" onClick="showYearSelect();">' +
    yearName +
    "</td></tr>\n";
  for (var i = 1; i <= 12; i++) {
    if (i % 3 == 1) res += "<tr>\n";
...
function printStyle() {
  ...
  res +=
    "  .thang {font-size: " +
    fontSize +
    "; padding:1; line-height:100%; font-family:Tahoma,Verdana,Arial; table-layout:fixed}\n";
  res +=
...
function printTable(mm, yy) {
  ...
  var res = "";
  res +=
    '<table class="thang" border="2" cellpadding="1" cellspacing="1" width="' +
    PRINT_OPTS.tableWidth +
    '">\n';
  res += printHead(mm, yy);
  for (i = 0; i < 6; i++) {
    res += "<tr>\n";
...
function printHead(mm, yy) {
  ...
  res +=
    '<td colspan="3" class="tenthang" onClick="showMonthSelect();">' +
    monthName +
    "</td>\n";
